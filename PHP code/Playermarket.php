...
<input type="button" value="Player Details" onclick="window.location.href='http://localhost/BallerIndex/PlayerDetails.php?id=<?php echo $uid ?>'" style="width:150px; height:70px;" />
<input type="button" value="Soccer PlayerMarket" onclick="window.location.href='http://localhost/BallerIndex/SPlayerMarket.php?id=<?php echo $uid ?>'" style="width:150px; height:70px;"/>
...
$sql = "SELECT  PlayerMarket.PlayerID,PlayerName,`Buy Rate`,`Sell rate` FROM PlayerMarket INNER JOIN Price ON PlayerMarket.PlayerID=Price.PriceID where PlayerMarket.GameTypeID=2";
